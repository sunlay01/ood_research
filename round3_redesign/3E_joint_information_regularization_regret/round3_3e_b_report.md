...
`1/2 ||A P_ker(O_S)||_op^2 = 0.05118145109`.  `total_excess` in the CSV is
...
- coupled world tangent: `8D`
- source observation shape: `(275, 8)`
- primary hidden-U floor: `0.05118145109`
    - U-exposed floor: `0`
- factorization residual: `4.89e-17`
- maximum IFT finite-difference error: `3.69e-10`
- maximum secular versus independent constrained optimizer error: `4.59e-14`
