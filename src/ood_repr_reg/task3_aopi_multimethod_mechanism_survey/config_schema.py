...
def validate_config(config: dict[str, Any]) -> dict[str, Any]:
    ...
    _require(float(vrex["lambda"]) == 10.0 and vrex["penalty_anneal_iters"] == 100, "wrong V-REx config")
    _require(vrex.get("whole_loss_rescale_after_anneal") is False, "V-REx cannot use IRM rescaling")
