...
6. **Common corollaries.** Use the same scientific construction rule, state
...
8. **Stable finite-sample geometry.** From the first population statement,
...
gate**. No algorithm-specific mapping, new regularizer, large benchmark, or
universal novelty claim should be started before those gates pass.
